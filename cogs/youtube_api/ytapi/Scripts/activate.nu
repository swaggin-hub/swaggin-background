...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Programming Shit\.swaggin-bots\swaggin-bot-py\cogs\youtube_api\ytapi'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Programming Shit\.swaggin-bots\swaggin-bot-py\cogs\youtube_api\ytapi\Scripts\deactivate.nu'
